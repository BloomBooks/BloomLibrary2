                    ...
                    book.languages.forEach((langTag) => {
                        ...
                        if (lang) {
                            ...
                            if (lang.bookCount === 1)
                                ...
                                // if this is the book's primary language, we want to know when it was first seen
                                // other languages may have been added later (or earlier)
                                // lang.langTag === book.lang1Tag &&
