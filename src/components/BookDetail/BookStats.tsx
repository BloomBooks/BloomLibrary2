    ...
    if (bookStats.totalreads)
        statStrings.push(
            l10n.formatMessage(
                {
                    id: "stats.book.reads",
                    defaultMessage: "{total} reads",
                },
                { total: bookStats.totalreads }
            )
        );
            ...
            l10n.formatMessage(
                {
                    ...
                    defaultMessage: "{total} downloads for translation",
                },
                { total: bookStats.shelldownloads }
            )
        );
