...
export const BookOwnerControlsBox: React.FunctionComponent<{
    ...
    const showSurfaceMetadataControls =
        userIsModerator ||
        // For now, we use userIsUploader because we have not yet implemented book modification
        // for non-uploaders. When we do, this should use editSurfaceMetadata instead.
        userIsUploader;
    //permissions.editSurfaceMetadata === true;
