            ...
            {props.book.rebrand && (
                ...
                >
                    ...
                    <BookDetailInfoWidget>
                        {
                            "This book appears to be a duplicate of another book with a new branding. For this reason, we do not include it in the general counts of books, and we don't show it in places where it would be a confusing duplicate."
                        }
                    </BookDetailInfoWidget>
                </div>
            )}
