...
// The ones present in this book are bloom-green, others are gray.
                    ...
                    {features.map((feature) =>
                        <a href={"/" + (feature.collectionHref || feature.featureKey)}>
                            {feature.icon({
                                ...
                                fill: feature.inCurrentBook ? commonUI.colors.bloomBlue : "#DDD", // They must have a color specified or will be transparent
