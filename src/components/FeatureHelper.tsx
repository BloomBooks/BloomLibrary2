...
export const featureSpecs: IFeatureSpec[] = [
    ...
    {
        featureKey: "quiz",
        featureTitle: activityFeatureSpec.featureTitle,
        description: activityFeatureSpec.description,
        icon: activityFeatureSpec.icon,
        languageDependent: activityFeatureSpec.languageDependent
    }
];
