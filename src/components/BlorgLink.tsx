...
export const BlorgLink: React.FunctionComponent<IBlorgLinkProps> = (props) => {
    ...
    const queryComponent = getToUrlQueryComponent(query);
...
// Returns the query component (the part including/after the question mark) of the new "To" URL
function getToUrlQueryComponent(query: URLSearchParams): string {
