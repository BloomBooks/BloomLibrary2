...
export const Header: React.FunctionComponent = () => {
    ...
    const searchBelow = !useMediaQuery("(min-width:975px)");
    const readCreateBelow = !useMediaQuery("(min-width:560px)");
    const shrinkReadCreate = !useMediaQuery("(min-width:640px)");
    ...
    const minTabWidth = shrinkReadCreate ? "min-width:110px" : "";
    ...
    const readCreateTabs = (
        <Tabs
            ...
            css={css`
                margin-left: ${readCreateBelow ? "0" : "30px"};
                margin-right: 30px;
                .MuiTabs-indicator {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {readCreateBelow || readCreateTabs}
                {searchBelow || (
                    <div
