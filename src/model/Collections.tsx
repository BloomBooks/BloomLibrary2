...
export function useGetCollection(
    ...
    if (templateFacetCollection) {
        ...
        // special cases here may need to be duplicated in cacheChildCollections,
        // in case a collection is first seen as a child.
        ...
        // I don't think we'll ever first see this except as a root.
    ...
    collection.childCollections.forEach((c) => {
        if (!collectionCache[c.urlKey]) {
            if (c.urlKey === "topics") {
                ...
                // whole block and instead populate the "Topics" collection on
                // Contentful
                c.childCollections = makeTopicCollectionsForCards();
            }
