...
// The result is cached in CachedTablesContext.
export function useGetCollections(): IRawCollection[] {
...
// A function for working with collections, generally retrieved from contentful.
// If `collections` (or `languages` if needed) is not yet populated,
...
export function getCollection(
    ...
    if (templateFacetCollection) {
        if (!languages.length) return { loading: true };
