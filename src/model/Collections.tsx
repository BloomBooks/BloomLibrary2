    ...
    const { loading, result } = useContentful(
        collectionName
            ? {
                  ...
                  // is also worth considering...we save 16% just by cutting out unused sys fields.
                  select:
                      "fields.bookSortOrder,fields.banner,fields.urlKey,fields.iconForCardAndDefaultBanner,fields.sponsorshipImage,fields.filter,fields.label,fields.richTextLabel,fields.description,fields.urlForBloomPubBundle,fields.urlForBloomSourceBundle,fields.statisticsQuerySpec,fields.hideLabelOnCardAndDefaultBanner,fields.childCollections,fields.expandChildCollectionRows,fields.layout,fields.rows,fields.useSimpleBookshelfFilter,sys.contentType,sys.id,sys.type",
                  include: 10, // depth
